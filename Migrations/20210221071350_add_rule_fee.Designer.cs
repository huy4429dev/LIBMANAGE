...
namespace LibManage.Migrations
{
    ...
    [Migration("20210221071350_add_rule_fee")]
    partial class add_rule_fee
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibManage.Models.OrderRuleFee", b =>
                {
                    b.Property<int>("RoleFeeId")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("RoleFeeId", "OrderId");

                    b.HasIndex("OrderId");

                    b.ToTable("OrderRuleFee");
                });
            ...
            modelBuilder.Entity("LibManage.Models.RuleFee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Description = "Mất tài liệu hoặc làm cho tài liệu hoàn toàn không sử dụng được: giá bìa của cuốn sách + 20$ phí phạt",
                            Name = "LOL 1",
                            Value = 100
                        },
                        new
                        {
                            Id = 2,
                            Description = "Làm bẩn, viết vẽ bẩn lên tài liệu: 10$/tờ",
                            Name = "LOL 2",
                            Value = 100
                        });
                });
            ...
            modelBuilder.Entity("LibManage.Models.OrderRuleFee", b =>
                {
                    b.HasOne("LibManage.Models.Order", "Order")
                        .WithMany("OrderRuleFees")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LibManage.Models.RuleFee", "RuleFee")
                        .WithMany("OrderRuleFees")
                        .HasForeignKey("RoleFeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Order");

                    b.Navigation("RuleFee");
                });
